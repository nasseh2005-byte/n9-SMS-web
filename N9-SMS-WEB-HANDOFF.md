...
> آخر تحديث توثيقي: 7 سبتمبر 2026 — توقيت الرياض
> حالة التطبيق: يعمل محلياً، وله نشر Sites خاص، ونسخة Vercel إنتاجية مفعلة بتخزين مشترك عبر Neon وPrivate Vercel Blob؛ الاختبارات الآلية الحالية ناجحة 47/47.
