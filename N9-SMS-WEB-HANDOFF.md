...
- الواجهة الخارجية أصبحت مسرح صورة كامل الشاشة: `public/og.png` للداكن، و`public/n9-hero-light.png` للفاتح اللؤلؤي ذي النيون الذهبي، و`public/n9-logo.jpg` شعار المنتج. مجلدات الصورة مرتبطة بمناطق تفاعل فعلية للتمرير والنقر، وتسجيل الدخول لا يظهر حتى ضغط زر الدخول ثم حركة فتح القفل وانزلاق اللوحة من الجانب (ومن الأسفل على الجوال).
