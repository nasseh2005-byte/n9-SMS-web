...
> حالة التطبيق: يعمل محلياً، وله نشر Sites خاص، ونسخة Vercel إنتاجية مفعلة بتخزين مشترك عبر Neon وPrivate Vercel Blob؛ الاختبارات الآلية الحالية ناجحة 44/44.
...
- الواجهة الخارجية أصبحت مسرح صورة كامل الشاشة: `public/og.png` للداكن، و`public/n9-hero-light.png` للفاتح اللؤلؤي ذي النيون الذهبي. `public/n9-logo-pearl-512.png` شعار الوضع الفاتح، و`public/n9-logo-night-512.png` الشعار الليلي الكحلي ذي النيون الأزرق، و`public/favicon-256.png` أيقونة المتصفح. مجلدات الصورة مرتبطة بمناطق تفاعل فعلية للتمرير والنقر، وتسجيل الدخول لا يظهر حتى ضغط زر الدخول ثم حركة فتح القفل وانزلاق اللوحة من الجانب (ومن الأسفل على الجوال).
...
- النسخة الفاتحة أصل بصري مستقل وليست فلتر CSS، وتُعرض بنفس أبعاد النسخة الداكنة. يجب إبقاء نقاط تفاعل المجلدات متوافقة مع مواضعها في الصورتين، مع دعم اللمس عبر أزرار ملفات منفصلة على الجوال.
...
```text
أنت تستلم مشروع N9 SMS Web قائم ويعمل. قبل أي تعديل اقرأ AGENTS.md كاملاً ثم اقرأ N9-SMS-WEB-HANDOFF.md كاملاً، واعتبرهما مرجعاً ملزماً. افحص git status وحافظ على تغييرات المستخدم. لا تعيد بناء المشروع من الصفر. لا تخلط بيانات الشركات، ولا تغيّر XML timestamps الأصلية، ولا تقص المحادثات أو نتائج المطابقة، وحافظ على هوية المرسل EJADA. منشئ الرسالة للمشرف فقط، والاختيار اليدوي هو الافتراضي. لا تغيّر شاشة الهاتف أو لقطة الدليل أو آلية التصدير أثناء تعديل Chrome الموقع أو ثيمه. شغّل الاختبارات والبناء بعد التعديل؛ خط الأساس الحالي 44 اختباراً ناجحاً. استخدم Neon وPrivate Vercel Blob في إنتاج Vercel ولا تسمح بالرجوع الصامت إلى IndexedDB. لا تجعل أي نشر عاماً ولا توسع الوصول من دون موافقة صريحة. نفذ طلبي الجديد فقط، ثم حدّث هذا المستند إذا أضفت قراراً أو ميزة دائمة.
```
