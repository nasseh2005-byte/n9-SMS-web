...
> حالة التطبيق: يعمل محلياً، وله نشر Sites خاص، ومجهز لنشر Vercel محلي البيانات؛ الاختبارات الآلية الحالية ناجحة 27/27.
...
- «تحديد الكل» يختار كل الرسائل الفريدة الظاهرة وفق بحث المرشحين الحالي، وليس فقط الدفعة المرسومة في DOM.
- «مسح التحديد» يعيد التصدير إلى أفضل/المختار الأساسي لكل رقم مطابق.
