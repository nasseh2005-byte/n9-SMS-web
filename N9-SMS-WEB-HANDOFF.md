...
> حالة التطبيق: يعمل محلياً، وله نشر Sites خاص، ونسخة Vercel إنتاجية مفعلة بتخزين مشترك عبر Neon وPrivate Vercel Blob؛ الاختبارات الآلية الحالية ناجحة 45/45.
...
- نافذة تقدم غير قابلة للإغلاق تعرض النسبة، المرحلة، وعدد الرسائل المنجزة منذ أول PDF حتى إغلاق ZIP وبدء التنزيل.
