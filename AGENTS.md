...
- Every evidence image includes visible provenance: imported archives are labeled as an imported SMS record, manually created messages are labeled as created inside N9, and bundled samples are labeled as demonstration data. Keep this distinction visible; do not make generated evidence indistinguishable from an unmarked native-phone screenshot.
