...
- Match candidates support independent multi-selection and select-all across the current candidate filter. With no explicit multi-selection, exports fall back to the smart/manual primary evidence for each matched identifier.
